...
function SchoolIdCardDetail() {
  ...
  return (
    <div style={containerStyle}>
      <div style={cardStyle}>
        <h3 style={headerStyle}>School ID Details</h3>
        <form>
          ...
          <div className="text-center">
            <button type="submit" className="btn btn-primary w-100">
              <Link to={'/SCard'} className="text-white text-decoration-none">
                SUBMIT
              </Link>
            </button>
          </div>
...
export default SchoolIdCardDetail;
