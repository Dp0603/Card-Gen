...
function EmployeeIdCardDetail() {
  ...
  return (
    <div style={containerStyle}>
      <div style={cardStyle}>
        <h3 style={headerStyle}>Employee ID Details</h3>
        <form>
          <div className="form-group mb-3">
            <label htmlFor="employeeName" style={labelStyle}>
              Employee Name
            </label>
            <input
          ...
          <div className="text-center">
            <button type="submit" className="btn btn-primary w-100">
              <Link to={'/ECard'} className="text-white text-decoration-none">
                SUBMIT
              </Link>
            </button>
          </div>
