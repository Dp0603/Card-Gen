...
function EventCard() {
  ...
  return (
    <div className="EventCard">
      ...
      >
        <div className="C1C">
          <h1>{details.eventName || "Event Name"}</h1>
          <h3>{details.eventDate || "Event Date"}</h3>
        </div>
        <div className="my-4 C1C">
          <span>{details.location || "Location"}</span>
          <span>{details.attendeeName || "Attendee Name"}</span>
          <span>{details.passType || "Pass Type"}</span>
        </div>
      </div>
      <div
        id="Card2"
